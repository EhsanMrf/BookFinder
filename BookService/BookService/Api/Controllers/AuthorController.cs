...
public class AuthorsController(IMediator mediator) : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ServiceResponse<IEnumerable<AuthorQueryModel>>> GetList()
    {
    ...
    public async Task<ServiceResponse<IEnumerable<AuthorBookQueryModel>>> GetAuthorBooks(Guid id)
    {
